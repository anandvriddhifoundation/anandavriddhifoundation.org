      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Ananda Vriddhi Foundation is a pioneering NGO in India using high-quality VR footage to give
            virtual tours of India's most beautiful destinations to underserved communities. In collaboration
            with <span className="font-semibold text-foreground">TellMe Digiinfotech</span>, we procure
            immersive content and conduct our signature{" "}
            <span className="font-normal text-warm-gold">"Dekho Apna Desh"</span> programme.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((v, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-serif font-normal text-foreground mb-3">{v.title}</h3>
